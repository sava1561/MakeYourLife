...
public class FastFood {
    ...
    public FastFood(float x, Player player,final Main main) {
        onscreen = true;
        texture = main.manager.get("background/fastfood.png",Texture.class);
        texture_snow = main.manager.get("background/fastfood_snow.png",Texture.class);
        ...
        Robb = new Variants(player.position.x + player.width / 2 - 8 * player.height / 8, 5 * player.position.y / 4 + player.height, 8 * player.height / 4, "background/robbMarket.png");
